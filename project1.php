...
?>
        ...
        <form action="" method="post">
                 ...
                 <label>1.what is your budget?</label><br>
                 <div class="form-check">
				 <input class="form-check-input" type="checkbox" name="pricepoint">
				 ...
				 <label>2.what lead time in business days is preferred?</label><br>
                 <div class="form-check">
				 <input class="form-check-input" type="checkbox" name="pre-time">
				 <label class="form-check-label">(i)5-10</label> </div>
				 <div class="form-check">
				 <input class="form-check-input" type="checkbox" name="pre-time">
				 ...
				 <div class="form-check">
				 <input class="form-check-input" type="checkbox" name="pre-time">
				 <label class="form-check-label">(iii)20-45</label>
				 </div><br>
				 
				 
				 <label>3.what type of construction?</label><br>
                 <div class="form-check">
				 <input class="form-check-input" type="checkbox" name="construction">
				 ...
				 <div class="form-check">
				 <input class="form-check-input" type="checkbox" name="construction">
				 <label class="form-check-label">(iii)all-plywood or furniture board</label>
				 </div><br>
				 
				 
				 <label>4.what style are you looking for?</label><br>
				<div class="form-check">
				 ...
				 <div class="form-check">
				 <input class="form-check-input" type="checkbox" name="style">
				 <label class="form-check-label">(iii)partial overlay,full overlay,flush inset,beaded inset or frameless</label>
				 </div><br>
				...
				<div class="form-check">
				 ...
				 <div class="form-check">
				 <input class="form-check-input" type="checkbox" name="customizable">
				 <label class="form-check-label">(ii)semi</label>
				 </div>
				 <div class="form-check">
				 <input class="form-check-input" type="checkbox" name="customizable">
				 <label class="form-check-label">(iii)full</label>
				 </div><br>
				 <div>

              <button type="submit" class="btn btn-primary" name="add">Submit</button></div>
